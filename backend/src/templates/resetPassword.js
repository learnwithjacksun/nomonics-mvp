export const generateResetPasswordTemplate = (name, url) => {
    return `<!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
        ...
        <style>
            ...
            .header {
                background: linear-gradient(135deg, #fdc700 0%, #4b2e00 100%);
                color: white;
                padding: 30px;
                text-align: center;
            }
    ...
    <body>
        <div class="container">
        <img src="https://res.cloudinary.com/dfbj3cyw5/image/upload/v1755171783/logo_p5xcdq.png" alt="Nomonics Logo" class="logo">
            <div class="header">
