...
export default function SellProducts() {
  ...
  return (
    <MainLayout>
      <MiniLayout
        title="Sell Products"
        subtitle="Add your comic on marketplace"
      >
          ...
          <Box>
            <div className="space-y-4">
              <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
                ...
                />
                <SelectWithoutIcon label="Genre" options={comicCategories} {...register("category")} error={errors.category?.message} />
              </div>
              <ImageUploader label="Product Image" image={image} setImage={setImage} />
