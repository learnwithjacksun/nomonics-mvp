...
export default function Comics() {
  const { creatorComics, isCreatorComicsLoading } = useComics();
  const [search, setSearch] = useState("");
  const [selectedGenre, setSelectedGenre] = useState<string>("all");

  const filteredComics = creatorComics?.filter((comic) => {
  ...
  return (
    <MainLayout
      title="My Comics"
      subtitle="View and manage all your uploaded and approved comics"
    >
