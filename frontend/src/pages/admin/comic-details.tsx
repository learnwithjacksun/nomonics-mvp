        ...
        <div className="w-full md:w-[900px] mx-auto grid md:grid-cols-2 grid-cols-1 gap-4 bg-background rounded-lg p-4 border border-line">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
                <span className="bg-primary text-primary-2 font-medium px-2 py-1 rounded-full text-xs">Pending</span>
                <span className="bg-green-500 text-white font-medium px-2 py-1 rounded-full text-xs">Approved</span>
            </div>
            <div>
